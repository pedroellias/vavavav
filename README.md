<img width="1280" alt="Horizontal bar" src="https://github.com/user-attachments/assets/5fdc2b02-b3a8-4800-a00d-c53cd6bcd46e" />

# VAVAVAV

## About the repository

This repo was created to archive the source code of my first game, [VAVAVAV](https://jobson50.itch.io/vavavav). It was made in 2025 as a project for the first semester of my Computer Science course, using [AppGameKit Classic](https://store.steampowered.com/app/325180/AppGameKit_Classic_Easy_Game_Development/), which has since been unfortunately [discontinued](https://www.thegamecreators.com/post/appgamekit-classic-has-now-been-retired).
...
- My friends Johas, Matheus, Davi and Darwin for helping me out along the development process.
- [DJARTMUSIC](https://pixabay.com/users/djartmusic-46653586/) for the background tracks.
- [Kenney's Game Assets](https://kenney.itch.io/) for the meteor sprites (modified by me).
- [somepx](https://somepx.itch.io/)'s Matchup Pro font (which I couldn't find on their page anymore, but it's located in [`/media/MatchupPro.ttf`](/media/MatchupPro.ttf)).
...
<img width="1280" alt="image" src="https://github.com/user-attachments/assets/6c8fdbf0-a5b1-4d08-9bdb-f2d540fdc4fd" />
